...
export const messages = {
  en: {
    ...
    haveDiscountCode:
      'You now have a discount code, please use it before using another one.',
    ...
    notInStatusEnum:
      'Sorry but status must be one of the following: Not Processed, Processing, Shipped, Delivered, Cancelled.',
    ...
    successfulSignUp: 'Account created successfully, please verify your email!',
